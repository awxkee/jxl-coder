...
#include "processing/BilateralBlur.h"
...
Java_com_awxkee_jxlcoder_processing_BitmapProcessor_bilateralBlurImpl(JNIEnv *env, jobject thiz,
                                                                      jobject bitmap, jfloat radius,
                                                                      jfloat sigma, jfloat spatialSigma) {
    try {
        ...
        bilateralBlur(rgbPixels.data(), dstStride, info.width, info.height, radius, sigma, spatialSigma);
