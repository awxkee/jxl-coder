...
#include "processing/MedianBlur.h"

using namespace std;

extern "C"
JNIEXPORT jobject JNICALL
Java_com_awxkee_jxlcoder_processing_BitmapProcessor_medianBlurImpl(JNIEnv *env, jobject thiz,
    ...
    try {
        ...
        medianBlurU8(rgbPixels.data(), dstStride, info.width, info.height, radius);
