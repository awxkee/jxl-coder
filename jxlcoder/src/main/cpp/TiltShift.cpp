...
#include "processing/GaussBlur.h"
#include "processing/TiltShift.h"
...
Java_com_awxkee_jxlcoder_processing_BitmapProcessor_tiltShiftImpl(JNIEnv *env, jobject thiz,
    ...
    try {
        ...
        std::vector<uint8_t> blurTexture(rgbPixels.size());
