...
```groovy
implementation 'com.github.awxkee:jxl-coder:1.7.3' // or any version above picker from release tags

// Glide JPEG XL plugin if you need one
implementation 'com.github.awxkee:jxl-coder-glide:1.7.3' // or any version above picker from release tags
