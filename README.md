...
```groovy
implementation 'com.github.awxkee:jxl-coder:1.5.4' // or any version above picker from release tags

// Glide JPEG XL plugin if you need one
implementation 'com.github.awxkee:jxl-coder-glide:1.5.4' // or any version above picker from release tags
